# Script for the analysis of ICPMS data
...
source("Functions_SeafastICPMS_DataAnalysis_030616.r")
...
# the function, DON'T CHANGE THE CODE HERE
fChecks.balances(ck, sa.sf, st.el, blank, ref.mat, mor, coding, sample.naming, name.run, mainDir, use.Blank, Seafast.conc.factor, outliers.boxplot,resolution.figures, cex, cex.lab, cex.axis, Standard.element.correction,Mo.correction.Cd)
...
# Other parameters, CAN BE CHANGED
Standard.element.correction <- "no"
use.Blank <- "mean"		# either use "mean" or "median"
Mo.correction.Cd <- "no"
